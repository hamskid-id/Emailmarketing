...
import { Actions } from "./subActions";
import { SubEdit } from "./subEdit";

export const SubTable =({setListSection})=>{
    ...
    if(subsriber.GetSubscribersStatus ==='pending'){
        ...
        return(
            <>
            <p className="fs-3">Subscribers</p>
            <Actions setListSection={setListSection}/>
